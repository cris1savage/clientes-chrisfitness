...
// Campos numéricos extra que se pueden registrar semana a semana
export const WEEK_METRICS = [
  { key: 'steps',     label: 'Pasos/día', unit: '',    color: '#4ADE80' },
  { key: 'kcal_on',   label: 'Kcal ON',   unit: 'kcal',color: '#FBBF24' },
  { key: 'kcal_off',  label: 'Kcal OFF',  unit: 'kcal',color: '#FB923C' },
  { key: 'dias_on',   label: 'Días ON',   unit: 'd',   color: '#FBBF24' },
  { key: 'adherence', label: 'Adherencia',unit: '%',   color: '#A78BFA' },
];

// Kcal media ponderada: (kcal_on × dias_on + kcal_off × dias_off) / 7
...
// Macros → kcal: Proteínas×4 + Carbos×4 + Grasas×9
